...
class OrderBookFlatSortedTest : public testing::Test {
    protected:
        OrderBookFlatSorted order_book;
};

TEST_F(OrderBookFlatSortedTest, AddBuyOrderFlatTest) {
    Order ord {
        .order_id = 1,
        .timestamp = 123,
        .price = 100,
...
TEST_F(OrderBookFlatSortedTest, AddSellOrderFlatTest) {
    Order ord {
        .order_id = 1,
        .timestamp = 123,
        .price = 100,
...
TEST_F(OrderBookFlatSortedTest, BestBidFlatTest) {
    Order ord_1 {
        .order_id = 1,
        .timestamp = 123,
        .price = 100,
...
TEST_F(OrderBookFlatSortedTest, BestAskFlatTest) {
    Order ord_1 {
        .order_id = 1,
        .timestamp = 123,
        .price = 100,
...
TEST_F(OrderBookFlatSortedTest, RemoveOrderBuy) {
    Order ord_1 {
        .order_id = 1,
        .timestamp = 123,
        .price = 100,
...
TEST_F(OrderBookFlatSortedTest, RemoveOrderBuyEmpty) {
    auto buy_order = order_book.remove_from_order(Side::BUY, 100);
    ASSERT_FALSE(buy_order.has_value());
}

TEST_F(OrderBookFlatSortedTest, RemoveOrderSell) {
    Order ord_1 {
        .order_id = 1,
        .timestamp = 123,
        .price = 100,
...
TEST_F(OrderBookFlatSortedTest, RemoveOrderSellEmpty) {
    auto sell_order = order_book.remove_from_order(Side::SELL, 100);
    ASSERT_FALSE(sell_order.has_value());
}

TEST_F(OrderBookFlatSortedTest, RemoveOrderCleansLevel) {
    Order ord {
        .order_id = 1,
        .timestamp = 123,
        .price = 100,
